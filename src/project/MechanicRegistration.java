...
public class MechanicRegistration extends JFrame{
    ...
    MechanicRegistration(){
        ...
        l1 =new JLabel("Mechanic Registration");
        l1.setBounds(135, 6, 290, 40);
        l1.setForeground(Color.black);
        l1.setFont(font);
        panel1.add(l1);

        panel2 =new JPanel();
        panel2.setBounds(4, 54, 550, 550);
        panel2.setBackground(Color.yellow);
        panel2.setLayout(null);
        add(panel2);

        l2 = new JLabel("User Name :");
        l2.setBounds(82, 22, 150, 25);
        l2.setFont(font2);
        panel2.add(l2);

        field1 = new JTextField();
        field1.setBounds(200, 22, 270, 25);
        panel2.add(field1);

        l3 = new JLabel("Full Name :");
        l3.setBounds(90, 66, 150, 25);
        l3.setFont(font2);
        panel2.add(l3);

        field2 = new JTextField();
        field2.setBounds(200, 66, 270, 25);
        panel2.add(field2);

        l4 = new JLabel("Email :");
        l4.setBounds(124, 110, 150, 25);
        l4.setFont(font2);
        panel2.add(l4);

        field3 = new JTextField();
        field3.setBounds(200, 110, 270, 25);
        panel2.add(field3);

        l5 = new JLabel("Password :");
        l5.setBounds(88, 154, 150, 25);
        l5.setFont(font2);
        panel2.add(l5);

        field4 = new JTextField();
        field4.setBounds(200, 154, 270, 25);
        panel2.add(field4);

        l6 = new JLabel("Confirm Password :");
        l6.setBounds(21, 198, 160, 25);
        l6.setFont(font2);
        panel2.add(l6);

        field5 = new JTextField();
        field5.setBounds(200, 198, 270, 25);
        panel2.add(field5);

        l7 = new JLabel("Mobile :");
        l7.setBounds(115, 242, 150, 25);
        l7.setFont(font2);
        panel2.add(l7);

        field6 = new JTextField();
        field6.setBounds(200, 242, 270, 25);
        panel2.add(field6);

        l8 = new JLabel("Address :");
        l8.setBounds(100, 286, 150, 25);
        l8.setFont(font2);
        panel2.add(l8);

        field7 = new JTextField();
        field7.setBounds(200, 286, 270, 25);
        panel2.add(field7);
