...
public class Mechanic extends JFrame {
    ...
    Mechanic() {
        ...
        panel1 = new JPanel();
        panel1.setBounds(4, 0, 460, 50);
        panel1.setBackground(Color.pink);
        add(panel1);
        panel1.setLayout(null);

        l1 = new JLabel("Mechanic Section");
        l1.setBounds(125, 4, 250, 40);
        ...
        bt3 = new JButton("Show News Latter");
        bt3.setBounds(108, 55, 235, 40);
...
//        bt3.addActionListener((ActionListener) this);
        ...
        bt4 = new JButton("Mechanic Info.");
        bt4.setBounds(108, 122, 235, 40);
        ...
        bt5 = new JButton("Mechanic Password Change");
        bt5.setBounds(108, 189, 235, 40);
